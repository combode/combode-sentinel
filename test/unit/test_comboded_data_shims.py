...
# TODO: remove fixtures below here once test_SHIM_serialise_for_comboded removed
...
@pytest.fixture
def comboded_superblock_hex():
    return ''

# ========================================================================


def test_SHIM_serialise_for_comboded(sentinel_proposal_hex, sentinel_superblock_hex):
    assert combodelib.SHIM_serialise_for_comboded(sentinel_proposal_hex) == ''
    assert combodelib.SHIM_serialise_for_comboded(sentinel_superblock_hex) == ''
...
def test_extract_object():
    ...
    expected = {
        ...
        'url': 'https://www.combodecentral.org/black-pearl',
